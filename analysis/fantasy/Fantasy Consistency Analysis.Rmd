...
source("/Users/samivanecky/git/nfl/getNFLData.R")
...
brkoutWr <- wr21 %>%
  filter(szn_avg_change_pct >= 25 & avg_pts_ppr >= 10 & n_games >= 10)
...
brkOutDf %>%
  ...
  ggplot2::labs(
    ...
    subtitle = "Showing shift in season average PPR points for the season following a breakout year. Breakout year identified by >= 30% improvement from previous season."
  ) +
  ggplot2::theme_bw() +
  ggplot2::theme(
    aspect.ratio = 9 / 16,
